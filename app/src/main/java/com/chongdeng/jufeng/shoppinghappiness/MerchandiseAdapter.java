 ...
 */
public class MerchandiseAdapter extends RecyclerView.Adapter<MerchandiseAdapter.MyViewHolder> {
    ...
    public MerchandiseAdapter(FragmentActivity mContext, List<Merchandise> merchandiseList) {
